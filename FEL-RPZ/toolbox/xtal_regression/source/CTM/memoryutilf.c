/* to get this to work on the mac, you are not able to pass offsets other than 0 */
/* THIS IS THE CODE USING FLOATS */
...
char error_text[];
{
	...
	fprintf(stderr,"Memory allocation run-time error...\n");
	fprintf(stderr,"%s\n",error_text);
