...
Coef(2) = 2 * (distribution2.Sigma^2 * distribution1.Mean - distribution1.Sigma^2 * distribution2.Mean);
Coef(3) = distribution1.Sigma^2 * distribution2.Mean^2 - distribution2.Sigma^2 * distribution1.Mean^2 + 2 * distribution1.Sigma^2 * distribution2.Sigma^2 * log(distribution1.Prior * distribution2.Sigma / (distribution2.Prior * distribution1.Sigma));
