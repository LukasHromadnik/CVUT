...
Individual * SinglePointCrossbreedingStrategy::crossbreed(Individual *parent1, Individual *parent2) {
	int randomPosition = rand() % parent1->size();
	
	Individual *child1 = new Individual(parent1->m_Knapsack);
	Individual *child2 = new Individual(parent1->m_Knapsack);
...
Individual * DoublePointCrossbreedingStrategy::crossbreed(Individual *parent1, Individual *parent2) {
	int randomPosition1 = rand() % parent1->size();
	int randomPosition2 = rand() % parent1->size();
