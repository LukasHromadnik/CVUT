...
class GameViewController: BaseViewController, ModelObservable {
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            bottomView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 15),
            bottomView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -15),
        ...
        NSLayoutConstraint.activate([
            ...
            divider.bottomAnchor.constraint(equalTo: bottomView.topAnchor, constant: -15),
        ...
        NSLayoutConstraint.activate([
            gameView.topAnchor.constraint(equalTo: view.topAnchor, constant: 66),
            gameView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            gameView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            gameView.bottomAnchor.constraint(equalTo: divider.topAnchor)
        ])
